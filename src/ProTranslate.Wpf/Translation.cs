...
public static class Translation
{
    public static readonly DependencyProperty CultureProperty =
        DependencyProperty.RegisterAttached(
            ...
            typeof(CultureInfo),
            typeof(Translation),
            new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.Inherits, OnCultureChanged));
    ...
    public static readonly DependencyProperty AutoFlowDirectionProperty =
        DependencyProperty.RegisterAttached(
            ...
            typeof(bool),
            typeof(Translation),
            new FrameworkPropertyMetadata(false, FrameworkPropertyMetadataOptions.Inherits, OnAutoFlowDirectionChanged));
    ...
    private static void OnCultureChanged(DependencyObject element, DependencyPropertyChangedEventArgs e)
    {
        ...
        {
            frameworkElement.Language = XmlLanguage.GetLanguage(culture.IetfLanguageTag);
        }

        if (GetAutoFlowDirection(element))
        {
            ApplyAutoFlowDirection(element, culture);
        }
    }
    ...
    private static void OnAutoFlowDirectionChanged(DependencyObject element, DependencyPropertyChangedEventArgs e)
    {
        ...
        {
            element.SetValue(FrameworkElement.FlowDirectionProperty, ToFlowDirection(GetCulture(element) ?? TranslationService.Culture));
        }
    ...
    private static void RefreshAttachedTarget(DependencyObject element)
    {
        ...
        ApplyAutoFlowDirection(element, GetCulture(element) ?? TranslationService.Culture);
    }

    private static void ApplyAutoFlowDirection(DependencyObject element, CultureInfo culture)
    {
        if (GetAutoFlowDirection(element))
        {
            element.SetValue(FrameworkElement.FlowDirectionProperty, ToFlowDirection(culture));
        }
    }
    ...
    private static void DispatchRefresh(DependencyObject element)
    {
        ...
        _ = element.Dispatcher.BeginInvoke(() => RefreshAttachedTarget(element));
    }
